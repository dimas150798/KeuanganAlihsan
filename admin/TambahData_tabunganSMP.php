<?php
    ...
    $jumlahhasil4 = array_sum($arrayhasil4);
        ...
        $hasil7=mysqli_query($koneksi,"SELECT * FROM db_validasi  where id_usaha = 'DTU008'");
    while ($jumlah7=mysqli_fetch_array($hasil7)){
    $arrayhasil7[] = $jumlah7['sub_total'];
    }
...
<div class="container-fluid">
    <h2 align="center" class="pt-3 pb-3">Input Data Pengeluaran SMP Integral</h2>
        ...
        <div class="col-sm-6 col-lg-12 ">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                    <label for="">Total Saldo Yayasan</label>
                        <input type="text" class="form-control" name="yayasan" value="<?=$jumlahhasil7?>" hidden>

                        <input type="text" class="form-control" name="" value="<?php echo number_format($jumlahhasil7,2,',','.') ?>" readonly>
                    ...
                    <label for="">Kategori  </label>
                        <select name="id_kategori"style="text-align:center;" class="form-control select-dropdown" required>
                            <option value="" selected disabled>Pilih Kategori  </option>
                            <?php
                            include "../koneksi/koneksi.php";
                            $query = mysqli_query($koneksi, "SELECT * FROM db_kategori_pengeluaran WHERE id_usaha = 'DTU004'");
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="kd_jumlah" placeholder="Ketikan Nominal" required>
                    </div>
                    <div class="col-md-6">
                        <label for="tempat">Keterangan</label>
                        <div class="input-group">
                        <input type="text" class="form-control" name="kd_keterangan" placeholder="Ketikan Keterangan" required>
                        </div>
                    </div>
                    </div>  
                    <div class="form-group">
                        <label for="gambar">Bukti Pengeluaran</label>
...
<?php
    ...
    if (isset($_POST['submit'])) {
        if ($_POST['kd_jumlah'] <= $_POST['max']) {
            if (tambahdatatabunganSMP($_POST) > 0){
                echo "
                <script>
