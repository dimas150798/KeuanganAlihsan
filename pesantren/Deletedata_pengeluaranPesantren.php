<?php
    ...
    $lokasi3 = "Delete Data Pesantren Tahfidz DH";
    $linklokasi2 = "";
    $linklokasi3 = "";
...
<?php
    ...
    if (isset($_POST['submit'])) {
        if (deletepengeluaranPesantren($id) > 0) {
    } if (DeleteValidasiPesantren($_POST) > 0){
        echo "
        <script>
        ...
        echo "
        <script>
            document.location.href = 'Deletedata_pengeluaranPesantren.php';
        </script>
        ";
        echo("<br>");
