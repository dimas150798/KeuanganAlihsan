<?php
    ...
    $lokasi3 = "";
    $linklokasi2 = "TambahData_BuktitransferPesantren.php";
    $linklokasi3 = "";
    ...
    //transfer
    $hasil2=mysqli_query($koneksi,"SELECT * FROM db_transfer where id_usaha = 'DTU005'");
          ...
          <br>
              <table>
                  ...
                  <tbody>
                      ...
                      <?php } ?>     
                      <td colspan="2"  width="150px" >Pesantren Tahfidz DH :</td>
