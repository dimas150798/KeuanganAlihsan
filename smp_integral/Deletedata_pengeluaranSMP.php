<?php
    ...
    $lokasi3 = "Delete Data SMP Integral";
    $linklokasi2 = "";
    $linklokasi3 = "";
    ...
    $hasil4=mysqli_query($koneksi,"SELECT anggaran * 0.75 AS totalkeseluruhan FROM db_validasi where id_usaha = 'DTU004'");
...
<?php
    ...
    if (isset($_POST['submit'])) {
        if (deletepengeluaranSMP($id) > 0) {
    } if (DeleteValidasiSMP($_POST) > 0){
        echo "
        <script>
        ...
        echo "
        <script>
            document.location.href = 'Deletedata_pengeluaranSMP.php';
        </script>
        ";
        echo("<br>");
