<?php
    ...
    $lokasi4 = "";
    $linklokasi2 = "EditData_pengeluaranSMP.php";
    $linklokasi3 = "TambahData_saldoSMP.php";
    $linklokasi4 = "";

    include "../smp_integral/template/header.php";   
    include "../smp_integral/template/menu.php";
    include "../smp_integral/template/lokasi2.php";
    ...
    WHERE a.id_pp = 2 AND a.id_usaha = 'DTU004'  AND c.id_kategori BETWEEN 'KAP075' AND 'KAP076'
    ");
...
<div class="container-fluid">
    <br>
        <h3 align="center">Detail Pengeluaran SMP Integral</h3>
