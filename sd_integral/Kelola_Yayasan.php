<?php
    ...
    $lokasi4 = "";
    $linklokasi2 = "EditData_pengeluaranSD.php";
    $linklokasi3 = "TambahData_saldoSD.php";
    $linklokasi4 = "";
    ...
    WHERE a.id_pp = 2 AND a.id_usaha = 'DTU003'  AND c.id_kategori BETWEEN 'KAP077' AND 'KAP078'
    ");
