...
<div class="container-fluid">
    <h2 align="center" class="pt-3 pb-3">Edit Data Laporan SD Integral</h2>
...
<?php
    ...
    if (isset($_POST['submit'])) {
        if (editdatalaporan($_POST) > 0){
            echo "
            <script>
            alert('Data Pemasukan Sudah Berhasil Di Edit');
            document.location.href = 'EditData_SD.php';
            </script>
            ";
        } else {
            echo "
            ...
            // document.location.href = 'EditData_laporanSD.php';            
            </script>
            ";
            echo("<br>");
