            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" class="form-control" name="id_data_input" value="<?=$kodetambahpengeluaranTK?>" hidden>
    ...
    if (isset($_POST['submit'])) {
        if ($_POST['kd_jumlah'] <= $_POST['max']) {
            if (tambahdatapengeluaransaldoTK($_POST) > 0){
                ...
                document.location.href = 'Kelola_YayasanTK.php';         
                </script>
                ";
            }   else {
                echo "
                ...
                document.location.href = 'TambahData_saldoTK.php';         
                </script>
                ";
                echo("<br>");
