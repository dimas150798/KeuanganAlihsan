<?php
    ...
    $linklokasi3 = "TambahData_saldoTK.php";
    $linklokasi4 = "";
    ...
    WHERE a.id_pp = 2 AND a.id_usaha = 'DTU001'  AND c.id_kategori BETWEEN 'KAP079' AND 'KAP080'
    ");
...
<div class="container-fluid">
    <br>
        <h3 align="center">Detail Pengeluaran KB - TK AL - Ihsan</h3>
                ...
                <tr align="center">
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <a href="Deletedata_YayasanTK.php?id=<?=$data['id_data_output']?>"  class="btn btn-danger"><i class="nav-icon fa fa-trash"></i> Hapus</a>
                        </div>
                    </td>
                </tr>
                    <?php } ?>
